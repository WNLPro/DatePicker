...
{
    if (mutableArray) [mutableArray removeAllObjects];
...
- (void)getNowDate:(NSDate *)date animated:(BOOL)animated
{
    ...
    if (self.datePickerStyle == DateStyleShowYearMonthDayHourMinute) indexArray = @[@(yearIndex), @(monthIndex), @(dayIndex), @(hourIndex), @(minuteIndex)];
    if (self.datePickerStyle == DateStyleShowYearMonthDay) indexArray = @[@(yearIndex), @(monthIndex), @(dayIndex)];
    if (self.datePickerStyle == DateStyleShowYearMonth) indexArray = @[@(yearIndex), @(monthIndex)];
    if (self.datePickerStyle == DateStyleShowMonthDayHourMinute) indexArray = @[@(monthIndex), @(dayIndex), @(hourIndex), @(minuteIndex)];
    if (self.datePickerStyle == DateStyleShowMonthDay) indexArray = @[@(monthIndex), @(dayIndex)];
    if (self.datePickerStyle == DateStyleShowHourMinute) indexArray = @[@(hourIndex), @(minuteIndex)];
    if (self.datePickerStyle == DateStyleShowYear) indexArray = @[@(yearIndex)];
    if (self.datePickerStyle == DateStyleShowMonth) indexArray = @[@(monthIndex)];
    if (self.datePickerStyle == DateStyleShowDayHourMinute) indexArray = @[@(dayIndex), @(hourIndex), @(minuteIndex)];
